      ...
      <div style={{ padding: '16px 20px' }}>
        ...
        <div style={{ marginBottom: '16px', paddingBottom: '16px', borderBottom: `1px solid ${borderColor}` }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
            <div>
              <span style={{ fontSize: '0.85rem', color: secondaryTextColor, opacity: 0.6, fontWeight: '500', letterSpacing: '0.5px' }}>Billing Plan</span>
            ...
            <div style={{ textAlign: 'right' }}>
              <span style={{ fontSize: '0.85rem', color: secondaryTextColor, opacity: 0.6, fontWeight: '500', letterSpacing: '0.5px' }}>Yearly Cost</span>
